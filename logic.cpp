...
void addRandomTile(vector < vector < int > >& board){
    ...
    for(int i = 0; i < SIZE; ++i) for(int j = 0; j < SIZE; ++j) if(board[i][j] == 0) emptyTile.push_back({i, j});
...
void moveLeft(vector < vector < int > >& board){
    for(int i = 0; i < SIZE; ++i){
        vector < int > row;
        for(int j = 0; j < SIZE; ++j) if(board[i][j] != 0) row.push_back(board[i][j]);
...
void moveRight(vector < vector < int > >& board){
    for(int i = 0; i < SIZE; ++i){
        vector < int > row;
        for(int j = SIZE - 1; j >= 0; --j) if(board[i][j] != 0) row.push_back(board[i][j]);
...
void moveUp(vector < vector < int > >& board){
    for(int i = 0; i < SIZE; ++i){
        vector < int > col;
        for(int j = 0; j < SIZE; ++j) if(board[j][i] != 0) col.push_back(board[j][i]);
...
void moveDown(vector < vector < int > >& board){
    for(int i = 0; i < SIZE; ++i){
        vector < int > col;
        for(int j = SIZE - 1; j >= 0; --j) if(board[j][i] != 0) col.push_back(board[j][i]);
